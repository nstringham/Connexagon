...
export const colors: Color[] = ["red", "blue", "green", "orange", "purple", "yellow"];
        ...
        case "DL":
          ...
          switch (direction) {
            ...
            case "UL":
              ...
              if (
                currentRow === 0 ||
                (above && (left ? RowStarts[currentRow] === current : RowStarts[currentRow + 1] - 1 === current))
              ) {
                return -1;
              }
            ...
            case "DL":
              ...
              if (
                ...
                (below && (left ? RowStarts[currentRow] === current : RowStarts[currentRow + 1] - 1 === current))
              ) {
                return -1;
              }
